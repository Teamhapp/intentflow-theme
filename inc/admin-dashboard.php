...
function intentflow_admin_styles($hook) {
    ...
    wp_register_style('intentflow-admin-inline', false);
    wp_enqueue_style('intentflow-admin-inline');
    wp_add_inline_style('intentflow-admin-inline',
        '.if-wrap{max-width:1100px;margin:20px auto 0;font-family:-apple-system,BlinkMacSystemFont,sans-serif}'
        ...
        . '.if-version{background:#eff6ff;color:#2563EB;padding:3px 10px;border-radius:99px;font-size:12px;font-weight:600}'
        ...
        . '.if-cards{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;margin-bottom:24px}'
        ...
        . '.if-card-stat .num.blue{color:#2563EB}.if-card-stat .num.green{color:#22C55E}.if-card-stat .num.orange{color:#F59E0B}.if-card-stat .num.red{color:#EF4444}'
        ...
        . '.if-field input[type=text],.if-field input[type=url],.if-field input[type=number],.if-field textarea,.if-field select{width:100%;padding:8px 12px;border:1px solid #d1d5db;border-radius:8px;font-size:14px}'
        ...
        . '.if-btn{display:inline-flex;align-items:center;gap:6px;padding:8px 16px;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;border:1px solid #d1d5db;background:#fff;color:#111827;transition:all .2s;text-decoration:none}'
        ...
        . '.if-btn-green:hover{background:#16a34a}'
